    ...
    <article class="card" [style.border-left-color]="project().color ?? 'var(--accent)'">
      <div class="card-body">
        ...
        <div class="progress-row">
          <div class="progress-track">
            <div class="progress-fill" [style.width.%]="project().stats.completionPct"></div>
          </div>
      ...
      <div class="card-actions">
        ...
        <div class="action-group">
          <button class="btn-action" (click)="edit.emit(project()); $event.stopPropagation()">
            Editar
          </button>
          <button class="btn-action" (click)="archive.emit(project()); $event.stopPropagation()">
            Archivar
          </button>
          <button
            class="btn-action danger"
            (click)="delete.emit(project()); $event.stopPropagation()"
          >
            Eliminar
          </button>
        </div>
