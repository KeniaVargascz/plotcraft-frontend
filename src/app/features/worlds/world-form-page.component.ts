...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, RouterLink, TagChipsInputComponent, TranslatePipe],
  template: `
    <section class="form-shell">
      <header class="hero card">
        ...
        <div class="header-actions">
          @if (isEdit()) {
            <a class="header-link" [routerLink]="['/mis-mundos', currentSlug, 'mapa']"
              >Edicion de mapas</a
            >
            <a class="header-link" [routerLink]="['/mis-mundos', currentSlug, 'world-building']"
        ...
        <section class="card form-pane">
          ...
          <section class="editor-field">
            <div class="editor-heading">
              <div>
                <span>Documento del mundo</span><br />
                <small
